	...
	namespace geo3d
	{
		...
		class AOBBox
		{
			...
			public:
				...
				const glm::vec3& operator[](size_t pos) const { return OrientedBoundingBox[pos]; }
			...
			const vml::geo3d::AABBox NullAABBox = vml::geo3d::AABBox(glm::vec3(0, 0,0), glm::vec3(0, 0,0));
