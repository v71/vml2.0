...
namespace fa2040
{
	...
	class DroneArbiter
	{
		...
		private:
			...
			const std::vector<fa2040::Drone*>    *Drones;
			int								      State;
			int								      TimerCounter;
			int								      TimerState;
...
//						vml::DebugRender->DrawLine(view, playerpos, dronei->GetRootModel()->GetTransformedPosition(), vml::colors::Red, true);
		...
		public:
			...
			void Mutex(vml::views::View* view, vml::scenes::Scene *scene)
			{
			...
			void Init(fa2040::CleoCopter* player, const std::vector<fa2040::Drone*>* drones )
			{
				if (!player)
