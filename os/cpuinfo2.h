	...
	namespace os
	{
		...
		class SystemInfo
		{
			...
			private:
				...
				void InitCaps()
				{
					...
					if (CpuIdMaxExtendedFunction >= 0x80000004)
					{
						regs.eax = 0x80000002;
						Invoke_cpuid(&regs);
						CPUBrandString = std::string((const char *)&regs.eax, 4);
						CPUBrandString += std::string((const char *)&regs.ebx, 4);
						CPUBrandString += std::string((const char *)&regs.ecx, 4);
						CPUBrandString += std::string((const char *)&regs.edx, 4);
						regs.eax = 0x80000003;
						Invoke_cpuid(&regs);
						CPUBrandString += std::string((const char *)&regs.eax, 4);
						CPUBrandString += std::string((const char *)&regs.ebx, 4);
				...
				void InitTimer()
				{
					...
					EstimatedCpuSpeed = (unsigned long)((ce - cs) * freq.QuadPart / (e.QuadPart - s.QuadPart));
				}
			...
			public:
				...
				const uint32_t GetLogicalProcessorsNumber()
				{
					if (CpuIdMaxFunction >= 1)
				...
				static const unsigned int DONOTOVERWRITE=0;
				static const unsigned int OVERWRITE=1;

				//-----------------------------------------------------------------------------

				bool ReportToFile(bool rewrite= DONOTOVERWRITE)
				{
					std::string filename = "cpuinfo.txt";

					std::ifstream file(filename);

					// If the file is not found, and rewrite is true then create the file
					...
					// write info in the outfile

					std::ofstream outfile(filename);

					outfile << "Vendor                      : " << GetCpuVendorString() << std::endl;
					outfile << "CodeName                    : " << GetCpuCodeNameString() << std::endl;
					outfile << "Brand                       : " << GetCpuBrandString() << std::endl;
					outfile << "VendorId                    : " << GetVendorId() << std::endl;
					outfile << "CodeNameId                  : " << GetCodeNameId() << std::endl;
					outfile << "Stepping                    : " << GetStepping() << std::endl;
					outfile << "Family                      : " << GetFamily() << std::endl;
					outfile << "Model                       : " << GetModel() << std::endl;
					outfile << "CPUMaxFunction              : " << GetCPUIdMaxFunction() << std::endl;
					outfile << "Processr Type               : " << GetProcessorType() << std::endl;
					outfile << "Extended Model              : " << GetExtendedModel() << std::endl;
					outfile << "Extended Family             : " << GetExtendedFamily() << std::endl;
					outfile << "Brand Index                 : " << GetBrandIndex() << std::endl;
					outfile << "CLFLUSH Cache line size     : " << GetCLFLUSHCacheLineSize() << std::endl;
					outfile << "API Physical ID             : " << GetAPICPhysicalID() << std::endl;
					outfile << "Cache line size             : " << GetCacheLineSize() << std::endl;
					outfile << "L2 Associativity            : " << GetL2Associativity() << std::endl;
					outfile << "Cache size                  : " << GetCacheSize() << std::endl;
					outfile << "Physical address            : " << GetPhysicalAddress() << std::endl;
					outfile << "Virtual address             : " << GetVirtualAddress() << std::endl;
					outfile << "Logical processor(s) number : " << GetLogicalProcessorsNumber() << std::endl;
				
					const int pos = 14;
			
					outfile << "Feature Bit [ " << 0 << "]" << std::setw(pos) << " : " << HasFeature( 0) << std::endl;
					outfile << "Feature Bit [ " << 1 << "]" << std::setw(pos) << " : " << HasFeature( 1) << std::endl;
					outfile << "Feature Bit [ " << 2 << "]" << std::setw(pos) << " : " << HasFeature( 2) << std::endl;
					outfile << "Feature Bit [ " << 3 << "]" << std::setw(pos) << " : " << HasFeature( 3) << std::endl;
					outfile << "Feature Bit [ " << 4 << "]" << std::setw(pos) << " : " << HasFeature( 4) << std::endl;
					outfile << "Feature Bit [ " << 5 << "]" << std::setw(pos) << " : " << HasFeature( 5) << std::endl;
					outfile << "Feature Bit [ " << 6 << "]" << std::setw(pos) << " : " << HasFeature( 6) << std::endl;
					outfile << "Feature Bit [ " << 7 << "]" << std::setw(pos) << " : " << HasFeature( 7) << std::endl;
					outfile << "Feature Bit [ " << 8 << "]" << std::setw(pos) << " : " << HasFeature( 8) << std::endl;
					outfile << "Feature Bit [ " << 9 << "]" << std::setw(pos) << " : " << HasFeature( 9) << std::endl;
					outfile << "Feature Bit [" << 10 << "]" << std::setw(pos) << " : " << HasFeature(10) << std::endl;
					outfile << "Feature Bit [" << 11 << "]" << std::setw(pos) << " : " << HasFeature(11) << std::endl;
					outfile << "Feature Bit [" << 12 << "]" << std::setw(pos) << " : " << HasFeature(12) << std::endl;
					outfile << "Feature Bit [" << 13 << "]" << std::setw(pos) << " : " << HasFeature(13) << std::endl;
					outfile << "Feature Bit [" << 14 << "]" << std::setw(pos) << " : " << HasFeature(14) << std::endl;
					outfile << "Feature Bit [" << 15 << "]" << std::setw(pos) << " : " << HasFeature(15) << std::endl;
					outfile << "Feature Bit [" << 16 << "]" << std::setw(pos) << " : " << HasFeature(16) << std::endl;
					outfile << "Feature Bit [" << 17 << "]" << std::setw(pos) << " : " << HasFeature(17) << std::endl;
					outfile << "Feature Bit [" << 18 << "]" << std::setw(pos) << " : " << HasFeature(18) << std::endl;
					outfile << "Feature Bit [" << 19 << "]" << std::setw(pos) << " : " << HasFeature(19) << std::endl;
					outfile << "Feature Bit [" << 20 << "]" << std::setw(pos) << " : " << HasFeature(20) << std::endl;
					outfile << "Feature Bit [" << 21 << "]" << std::setw(pos) << " : " << HasFeature(21) << std::endl;
					outfile << "Feature Bit [" << 22 << "]" << std::setw(pos) << " : " << HasFeature(22) << std::endl;
					outfile << "Feature Bit [" << 23 << "]" << std::setw(pos) << " : " << HasFeature(23) << std::endl;
					outfile << "Feature Bit [" << 24 << "]" << std::setw(pos) << " : " << HasFeature(24) << std::endl;
					outfile << "Feature Bit [" << 25 << "]" << std::setw(pos) << " : " << HasFeature(25) << std::endl;
					outfile << "Feature Bit [" << 26 << "]" << std::setw(pos) << " : " << HasFeature(26) << std::endl;
					outfile << "Feature Bit [" << 27 << "]" << std::setw(pos) << " : " << HasFeature(27) << std::endl;
					outfile << "Feature Bit [" << 28 << "]" << std::setw(pos) << " : " << HasFeature(28) << std::endl;
					outfile << "Feature Bit [" << 29 << "]" << std::setw(pos) << " : " << HasFeature(29) << std::endl;
					outfile << "Feature Bit [" << 30 << "]" << std::setw(pos) << " : " << HasFeature(30) << std::endl;
					outfile << "Feature Bit [" << 31 << "]" << std::setw(pos) << " : " << HasFeature(31) << std::endl;
				...
				std::string ReportToString(bool rewrite = DONOTOVERWRITE)
				{
					std::string output;
