	...
	namespace meshes
	{
		namespace procedural
		{
			...
			namespace cube
			{
				...
				const static unsigned int Surfaces = 12;

				// vertices

				const static float VertexPositionArray[] =
				{
					// front surface
				...
				const static float VertexNormalArray[] =
				{
					// front surface
				...
				const static float VertexUVArray[] =
				{
					// front surface
				...
				const static unsigned int TrianglesArray[] =
				{
				   0,  2,  1,
				   0,  3,  2,
				   4,  5,  6,
			...
			namespace pyramid
			{
				...
				const static unsigned int Vertices = 16;
				const static unsigned int Surfaces = 6;
			...
			} // end of pyramid namespace

			// plane 

			namespace plane
			{
				// vertices and surfaces count

				const static unsigned int Vertices = 4;
				const static unsigned int Surfaces = 2;
