		...
		class QuadPerVertexColor
		{
			...
			public:
				...
				QuadPerVertexColor()
				{
					...
					Shader = vml::ShaderStore->Load(shaderstorepath + "\\debug\\debug_color.shd");
				...
				~QuadPerVertexColor()
				{
					...
					std::string shaderstorepath = vml::Session::GetInstance()->GetMainPath() + "\\content\\opengl\\shaders";
					vml::ShaderStore->UnLoad(shaderstorepath + "\\debug\\debug_color.shd");
				}
		...
		class AlphaTexturedQuad
		{
			...
			public:
				...
				AlphaTexturedQuad()
				{
					...
					Shader = vml::ShaderStore->Load(shaderstorepath + "\\debug\\debug_texture_alpha.shd");
				...
				~AlphaTexturedQuad()
				{
					...
					if (BufferObjects[1]) { glDeleteBuffers(1, &BufferObjects[1]); BufferObjects[1] = 0; }
					std::string shaderstorepath = vml::Session::GetInstance()->GetMainPath() + "\\content\\opengl\\shaders";
					vml::ShaderStore->UnLoad(shaderstorepath + "\\debug\\debug_texture_alpha.shd");
				}
		...
		class AlphaColorTexturedQuad
		{
			...
			public:
				...
				AlphaColorTexturedQuad()
				{
					...
					Shader = vml::ShaderStore->Load(shaderstorepath + "\\debug\\debug_texture_alpha_color.shd");
				...
				~AlphaColorTexturedQuad()
				{
					...
					std::string shaderstorepath = vml::Session::GetInstance()->GetMainPath() + "\\content\\opengl\\shaders";
					vml::ShaderStore->UnLoad(shaderstorepath + "\\debug\\debug_texture_alpha_color.shd");
				}
