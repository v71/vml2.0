	...
	namespace debugrendering
	{
			...
			class Triangle
			{
				...
				public:
					...
					void Draw(vml::views::View* view,float scale, const glm::vec3& center, const glm::vec4& col, bool wire=false,bool drawpoints = true)
					{
						if (view)
						{
					...
					void Draw(vml::views::View* view,const glm::vec3& p0, const glm::vec3& p1, const glm::vec3& p2, const glm::vec4& col, bool wire = false, bool drawpoints = true)
					{
						if (view)
						{
